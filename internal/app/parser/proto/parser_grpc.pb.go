...
const (
	Parser_Download_FullMethodName = "/parser.Parser/Download"
)
...
type ParserClient interface {
	Download(ctx context.Context, in *LinkRequest, opts ...grpc.CallOption) (*StatusReply, error)
}
...
func (c *parserClient) Download(ctx context.Context, in *LinkRequest, opts ...grpc.CallOption) (*StatusReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatusReply)
	err := c.cc.Invoke(ctx, Parser_Download_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ParserServer interface {
	Download(context.Context, *LinkRequest) (*StatusReply, error)
...
func (UnimplementedParserServer) Download(context.Context, *LinkRequest) (*StatusReply, error) {
...
func _Parser_Download_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LinkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ParserServer).Download(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Parser_Download_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ParserServer).Download(ctx, req.(*LinkRequest))
	}
...
var Parser_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Download",
			Handler:    _Parser_Download_Handler,
		},
	},
